 ...
 * 
 * this.startMenu.add({ text: 'Grid Window', iconCls:'icon-grid', handler : this.createWindow, scope: this });
 * 
 * this.startMenu.addTool({ text:'Logout', iconCls:'logout', handler:function(){ window.location = "logout.php"; }, scope:this });
 */
...
Ext.ux.StartMenu = Ext.extend(Ext.menu.Menu, {
			 ...
			 * @param {String} position (optional) The {@link Ext.Element#alignTo} anchor position to use in aligning to the element (defaults to
			 *            this.defaultAlign)
