...
* 
* This plugin assumes that it has control over the features used for this particular grid section and may conflict with other plugins.
* 
...
Ext.ux.PreviewPlugin = function (cfg) {
    cfg = cfg || {};
    ...
    cfg.hideBodyCls = 'x-grid-row-body-hidden';

    /**
    * @cfg {String} bodyField Field to display in the preview. Must me a field within the Model definition that the store is using.
    */
    cfg.bodyField = '';
...
Ext.preg('preview', Ext.ux.PreviewPlugin);
